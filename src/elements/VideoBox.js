        ...
        <>
            <div className="row">
                <div className="col-xl-6 col-lg-7 col-md-8 wow fadeInUp" data-wow-delay="0.2s">
                    <h2 className="text-white title mb-4">Levantamiento de<br /> <span className="text-primary">Pesas</span></h2>
                    <Link to="/contact-us" className="btn btn-primary btn-skew"><span>Ver</span></Link>
                </div>
                <div className="col-xl-6 col-lg-5 col-md-4 d-flex justify-content-center align-items-center wow fadeInUp" data-wow-delay="0.4s">
                    <Link  onClick={() => { open(true) }} to={"\src\assets\videos\videodaniel.mp4"} >
